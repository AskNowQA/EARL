...
if __name__ == '__main__':
    ...
    bst.load_model('models/db_predia_reranker.model')
    for dat in data:
        rerank_test(dat['ES_content'], bst)
    print reranked_list[0] 
    print reranked_list[1]
    reranked_file = data_file.split('.')[0] + '_reranked.json'
    f = open(reranked_file, 'w')
    for lst in reranked_list:
